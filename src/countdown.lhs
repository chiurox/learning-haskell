...
>
> choices                       :: [a] -> [[a]]
> choices xs                    =  concat $ map perms $ subs xs -- or my first solution: [choice | subsets <- subs xs, choice <- perms subsets]
...
> split []                      =  []
> split [_]                     =  []
> split (x:xs)                  =  ([x], xs) : [(x : leftside, rightside) | (leftside, rightside) <- split xs]
> 
> exprs                         :: [Int] -> [Expr]
> exprs []                      =  []
> exprs [n]                     =  [Val n]
